...
function Choice({
  ...
  return (
    <button
      className={`rounded-md py-[3px] text-center font-sans text-[8.5px] ${
        selected
  ...
  return (
    <div className="flex h-full flex-col px-4 py-3">
      ...
      <div className="mt-2 rounded-xl bg-sand-warm p-2.5">
        ...
        <p className="font-sans text-[9px] leading-relaxed text-anthracite-soft">
          ...
          jäteastioihin. Lemmikkieläimet ovat sallittuja, mutta niitä ei saa
          päästää yhteisiin tiloihin.
        </p>
      </div>

      <p className="mt-2.5 font-display text-[9.5px] font-semibold text-anthracite">
        Oikein vai väärin?
      </p>
      ...
      <div className="mt-1.5 space-y-1.5">
        {questions.map((q, i) => (
          <div key={i}>
            <p className="font-sans text-[9px] leading-snug text-anthracite-soft">
              {i + 1}. {q.text}
            </p>
